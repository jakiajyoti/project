...
public class ViewEmployee extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getEmployee(){
        class GetEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ViewEmployee.this,"ডাঁটা সংগ্রহ হচ্ছে...","অপেক্ষা করুন...",false,false);
            }
    ...
    private void deleteEmployee(){
        class DeleteEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ViewEmployee.this, "ডাঁটা আপডেট  হচ্ছে...", "অপেক্ষা করুন...", false, false);
            }
    ...
    private void confirmDeleteEmployee(){
        ...
        alertDialogBuilder.setMessage("আপনি কি ডিলিট করতে চান ?");
